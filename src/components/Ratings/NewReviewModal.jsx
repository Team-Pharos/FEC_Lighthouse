            ...
            <div className='characteristics'>
              {availableCharacteristics.includes('Size') && (<div>
                ...
                <div>
                  ...
                  <input type='radio' value='5' id='size5' name={characteristics['Size'].id} onChange={charHandler} checked={sizeSelection === '5'} />
                  <Label for='size1'>1 size too small</Label></div>
              </div>)}
              ...
              {availableCharacteristics.includes('Comfort') && (<div>
                ...
                <Radio>
                  ...
                  {comfortSelection === '2' && <Label for='com2'>slightly uncomfortable</Label>}
                </Radio>
                ...
                <Radio>
                  ...
                  {comfortSelection === '4' && <Label for='com4'>comfortable</Label>}
                </Radio>

                <Radio>
                  <input type='radio' value='5' id='com5' name={characteristics['Comfort'].id} onChange={charHandler} checked={comfortSelection === '5'} />
              ...
              {availableCharacteristics.includes('Length') && (<div>
                ...
                <Radio>
                  ...
                  {lengthSelection === '2' && <Label for='length2'>runs slightly short</Label>}
                </Radio>

                <Radio>
                  <input type='radio' value='3' id='length3' name={characteristics['Length'].id} onChange={charHandler} checked={lengthSelection === '3'} />
                  {lengthSelection === '3' && <Label for='length3'>perfect</Label>}
                </Radio>

                <Radio>
                  <input type='radio' value='4' id='length4' name={characteristics['Length'].id} onChange={charHandler} checked={lengthSelection === '4'} />
                  {lengthSelection === '4' && <Label for='length4'>runs slightly long</Label>}
                </Radio>

                <Radio>
                  <input type='radio' value='5' id='length5' name={characteristics['Length'].id} onChange={charHandler} checked={lengthSelection === '5'} />
              ...
              {availableCharacteristics.includes('Fit') && (<div>
                ...
                {fitSelection === '2' && <Label for='fit2'>runs slightly tight</Label>}
                </Radio>
                ...
                {fitSelection === '4' && <Label for='fit4'>runs slightly large</Label>}
                </Radio>
